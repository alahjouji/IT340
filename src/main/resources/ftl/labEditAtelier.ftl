                ...
                <div class="col-xs-12 col-lg-10">
					...
					<div class="content" id="corpus">
						...
						<form action="/labs/editAtelier" id="LabEditAtelierForm" method="post" accept-charset="utf-8">
							...
							<div class="form-group">
									<input type="number" step="1" name="data[Atelier][duree]" value="${atelier.duree}" role="form" class="form-control input-xxlarge"  maxlength="100" type="text" id="Duree" required="required"/>
							</div>
							...
							<div class="form-group">
									<input type="number" step="1" name="data[Atelier][capacite]" value="${atelier.capacite}" role="form" class="form-control input-xxlarge"  maxlength="100" type="text" id="Capacite" required="required"/>
							</div>
							<br/>
