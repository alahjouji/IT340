                ...
                <div class="col-xs-12 col-lg-10">
					...
					<div class="content" id="corpus">
						...
						<p>
							...
							Si vous n’avez pas encore créé de compte vous pouvez le faire <a href="/labs/register">en cliquant ici</a>.
							<br/>
						</p>
						<form action="/labs/login" id="LabLoginForm" method="post" accept-charset="utf-8">
